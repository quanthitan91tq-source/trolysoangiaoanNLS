...
<div class="main-header">
    ...
    <p>Tác giả: Quan Thị Tân - Trường Tiểu Học Minh Quang - ĐT: 0963 825 455</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Quan Thị Tân - Trường Tiểu học Minh Quang - ĐT: 0963 825 455</div>", unsafe_allow_html=True)
